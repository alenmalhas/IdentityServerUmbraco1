...
using Umbraco1.Models.UmbracoIdentity;
using Umbraco1;
using Owin;
using Umbraco.Web;
...
namespace Umbraco1
{
    ...
    public class UmbracoIdentityStartup : UmbracoDefaultOwinStartup
    {
        ...
        protected override void ConfigureMiddleware(IAppBuilder app)
        {
            ...
            app.UseIdentityServerAuthentication("http://localhost:5000", "umbraco", "http://localhost:53068/");//"http://localhost:5001/");
